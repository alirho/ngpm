...
2. کامنت‌گذاری و مستند‌سازی خوب در کد
3. درک نسبتا خوبی از کدهای پیاده‌سازی شده دارد و از آن می‌توان برای بازبینی (review) کدهای ابزارهای دیگر استفاده کرد.
...
##### معایب
1. مشخص نبودن تغییرات انجام شده در کد در داخل ویرایشگر
2. عدم دسترسی به تاریخچه گفتگو با مدل
3. به صورت پیش‌فرض با چارچوب react پیاده‌سازی را انجام می‌دهد.
	1. تلاش‌های برای پیاده‌سازی با چارچوب vue موفق نبوده است.
	2. توانایی پیاده‌سازی بدون استفاده از چارچوب‌ها (pure javascript) را دارد.
4. عدم توانایی پیاده‌سازی کدهای بخش سرور

##### مزایا
1. درک خیلی خوب از پرامپت‌ها و ویژگی‌های درخواستی دارد.
	1. کدهای تحویل داده شده نسبت به ابزارهای دیگر مشکلات (bug) کمتری دارد.
	2. توانایی خوبی در درک ویژگی‌های پیچیده دارد.
2. داشتن ویرایشگر کد
	1. با داشتن ویرایشگر کد، می‌توان کد را اصلاح کرد و مدل بر روی کد اصلاح شده کار را ادامه می‌دهد.
3. کامنت گذاری کد
4. نمایش خروجی در وبگاه
...
7.  امکان تبدیل طرح بر اساس پیوند فیگما یا عکس
	1. برخی جزئیات را به خوبی پیاده‌سازی نمی‌کند و نیازمند اصلاح است.
